...
import com.hoavtm.lab5.bai2.adapters.ModuleAdapter;
...
public class MainActivity_Lab5_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Thêm dữ liệu mẫu
        moduleList.add(new Module(R.drawable.android, "ListView trong Android", "Android ListView là một view chứa nhóm các mục và hiển thị trong một danh sách có thể cuộn được.", "Android"));
        moduleList.add(new Module(R.drawable.ios, "Xử lý sự kiện trong iOS", "Trong iOS, xử lý sự kiện là quá trình nhận và phản hồi các hành động của người dùng hoặc các sự kiện hệ thống", "iOS"));
        ...
        builder.setTitle("Add New Module")
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        int selectedImage = selectedOSIndex == 0 ? R.drawable.android : R.drawable.ios;
